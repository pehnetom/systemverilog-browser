    ...
    displayElements(editor,self,parentElement,elementList,indent){
      for (var i = 0; i < Object.keys(elementList).length; i++) {
        (function () {
          ...
          localLine.addEventListener("mouseenter",function(){console.log(this);this.classList.add('selected');});
          localLine.addEventListener("mouseleave",function(){console.log(this);this.classList.remove('selected');});
